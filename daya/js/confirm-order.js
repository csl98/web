	...
	if(aInfo){
		for( var i=0; i<aInfo.length; i++){
			if(aInfo[i]!="null"){
				...
				var trInnerHtml="<td style='text-align:left'><a href='pro-details.html'><img style='width:101px; height:101px' src="+aInfo[i][0]+"><p>"+aInfo[i][1]+"</p></a></td><td>20mm</td><td><i>￥"+aInfo[i][2]+"</i><b>￥"+aInfo[i][3]+"</b></td><td><b>"+aInfo[i][4]+"</b></td><td><em>￥"+Number(aInfo[i][3]*aInfo[i][4]).toFixed(2)+"</em></td>";
