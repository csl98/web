(function(){
	...
	if(aInfo){
		for( var i=0; i<aInfo.length; i++){
			if(aInfo[i]!="null"){
				var trInnerHtml="<tr><td><a href='pro-details.html'><img style='width:67px; height:67px' src="+aInfo[i][0]+"><p>"+aInfo[i][1]+"</p></a></td><td><p>￥"+aInfo[i][3]+"</p></td><td><p>"+aInfo[i][4]+"</p></td><td><p>待发货</p></td><td><p>￥"+Number(aInfo[i][3]*aInfo[i][4]).toFixed(2)+"</p></td></tr>";
