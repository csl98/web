...
for( var i=0; i<aLabel.length; i++){
	...
	aLabel[i].attachEvent("onclick",function(){
...
function fnCreate(){
	...
	if(aInfo){
		for( var i=0; i<aInfo.length; i++){
			if(aInfo[i]!="null"){
				var trInnerHtml="<tr index="+i+"><td style='text-align:left; padding-left:20px;'><input type='checkbox'><a href='pro-details.html'><img style='width:105px; height:105px' src="+aInfo[i][0]+"></a><label></label></td><td style='text-align:left;'><a href='pro-details.html'>"+aInfo[i][1]+"</a></td><td>20mm</td><td><span>￥"+aInfo[i][2]+"</span><b>￥"+aInfo[i][3]+"</b></td><td class='num'><a href='javascript:;'>-</a><input type='text' value='"+aInfo[i][4]+"'><a href='javascript:;'>+</a></td><td><em>￥"+Number(aInfo[i][3]*aInfo[i][4]).toFixed(2)+"</em></td><td class='operation'><a href='javascript:;'>移入收藏夹</a><a href='javascript:;'>删除</a></td></tr>";
